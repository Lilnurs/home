...
public class Main {
    ...
    public static int[] heroesHealth = {250, 270, 280,250,350};
    public static int[] heroesDamage = {25, 20, 15,15,5};
    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medic","Galem"};
        ...
        for (int i = 0; i <heroesHealth.length ; i++) {
            ...
            continue;
                ...
                if(heroesHealth[i] > 0 && heroesHealth[i] < 100) {
                    ...
                    System.out.println("Медик вылечил героев");
                    break;
                }
    ...
    public static void galemDefence(){
        for (int i = 0; i < heroesHealth.length ; i++) {
            if (heroesHealth[4] > 0 && heroesHealth[i] > 0 && heroesHealth[4] != heroesHealth[i]){
                ...
                System.out.println("Галем защитил героев");
            }
